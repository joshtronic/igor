...
SELF_REPO="$AUTOMERGE_SELF_REPO"    # joshtronic/igor's real slug, reused as a fixture key below --
                                     # forgejo_repo_get_file_status is stubbed and the ancestry check
                                     # below points AGENT_HOME at a synthetic fixture repo, so nothing
                                     # here actually reads this harness's own live dossier or history
